...
@section('content')
    <form action="{{ route('template-summary.siladex.export') }}" method="POST" id="siladexTemplateForm"
                    ...
                    <div class="text-base leading-relaxed text-slate-700 dark:text-slate-300 template-text">
                        ...
                        <p class="font-bold text-center text-base mb-4">
                            (<input type="text" name="judul_formula" class="template-input sync-input w-96"
                                data-sync="formula" placeholder="(OPTIMASI PROSES)">) DI LINE
                        ...
                        <div
                            ...
                            <p>
                                ...
                                <input type="text" name="batch_kode_list" class="template-input sync-input w-64"
                                    data-sync="batch" placeholder="L25A15, L25A16, L25A17">:
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                <input type="text" name="kesimpulan_nama_produk"
                                    ...
                                    placeholder="Siladex Antitussive 60 mL">,
                                yakni pada batch
    ...
    <script>
        ...
        function collectFormValues() {
            ...
            document.querySelectorAll(
                    '#siladexTemplateForm input[name]:not([type="file"]), #siladexTemplateForm textarea[name], #siladexTemplateForm select[name]'
                )
                .forEach(input => {
        ...
        function collectDraftState() {
            ...
            document.querySelectorAll(
                    '#siladexTemplateForm input[name], #siladexTemplateForm textarea[name], #siladexTemplateForm select[name]')
                .forEach(field => {
                    if (field.disabled) {
        ...
        async function saveDraft() {
            ...
            try {
                const form = document.getElementById('siladexTemplateForm');
                const formData = new FormData(form);
                formData.delete('_token');
                formData.append('_token', CSRF_TOKEN);
                const state = collectDraftState();

                const product = (state.form_values.judul_nama_produk || '').trim() || 'Siladex Antitussive 60 ml';
        ...
        const SAVE_DRAFT_URL = "{{ route('template-summary.siladex.draft', [], false) }}";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ===========================================
            const siladexForm = document.getElementById('siladexTemplateForm');
            if (siladexForm) {
        ...
        function showExportModal() {
            ...
            if (!tokenInput) {
                ...
                document.getElementById('siladexTemplateForm').appendChild(tokenInput);
            }
