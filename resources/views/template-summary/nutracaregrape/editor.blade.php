        ...
        <div class="max-w-5xl mx-auto flex flex-col gap-6 pb-24">
                    ...
                    <div class="text-base leading-relaxed text-slate-700 dark:text-slate-300 template-text">
                        <p class="font-bold text-center text-base mb-2">
                            ...
                            <input type="text" name="judul_nama_produk" class="template-input sync-input w-72 uppercase"
                                data-sync="nama_produk" data-sync-master="1" placeholder="Nutracare Grape Seed">
                        </p>
                    ...
                    <div class="bab1-section" data-section-id="1">
                        ...
                        <div class="bab1-section-content ml-4 text-base leading-relaxed text-slate-700 dark:text-slate-300 template-text text-justify transition-opacity duration-200">
                            ...
                            <p>
                               ...
                               Summary validasi ini bertujuan mendokumentasika hasil studi validasi proses atau pembuktian terhadap kualitas dan reprodusibilitas proses pengolahan produk
                                ...
                                yang merupakan di Lini
                                <input type="text" name="tujuan_line" class="template-input sync-input w-56"
                        ...
                        <div
                            ...
                            <p>
                                ...
                                <input type="text" name="batch_jumlah_botol" class="template-input w-24"
                                    placeholder="19.99">
                                kg
                                (<input type="text" name="batch_jumlah_kapsul" class="template-input w-20"
                                    placeholder="57.137">
                                kapsul @
                                <input type="text" name="batch_satuan" class="template-input w-20"
                                    placeholder="350 mg">)
            ...
            <div
                ...
                <div class="p-6 flex flex-col gap-6">
                    ...
                    <div class="bab2-section" data-section-id="1">
                        <div class="bab2-section-content text-base leading-relaxed text-slate-800 dark:text-slate-300 template-text text-justify transition-opacity duration-200">
                                <span class="bab2-number font-semibold cursor-pointer select-none px-1 py-0.5 rounded hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 transition-colors"
                                    onclick="toggleBab2Section(this)" title="Klik untuk disable/enable">2.1.</span> Seluruh tahapan pengolahan dan pengemasan primer
                                <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-53"
                                    data-sync="nama_produk" placeholder="Nutracare Grape Seed">
                                yaitu
                            <input type="text" name="rangkuman_metode" class="template-input sync-input w-128"
                                ...
                                telah dilakukan MBR Skala Produksi Pengolahan 
                                <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-53"
                                    data-sync="nama_produk" placeholder="Nutracare Grape Seed">
                                , no. dokumen
                 ...
                 {{--2.2.2.1--}}
                 <div class="bab22-subab" data-subab-key="partikel_asing" data-subab-id="2">
                    <h4 class="font-medium text-slate-700 dark:text-slate-300 mb-2 flex items-start gap-2">
                        <span
                            class="bab22-number bab22-toggle-number font-bold cursor-pointer select-none px-1 py-0.5 rounded hover:bg-red-50 dark:hover:bg-red-900/20 hover:text-red-600 transition-colors"
                            onclick="toggleBab22Subab(this)" title="Klik untuk disable/enable">2.2.2.1</span>
                         <span class="flex-1 text-justify text-base">
                    ...
                    <div class="mixing-tables-container flex flex-col gap-3 ml-4">
                        <div class="mixing-table-item border border-slate-300 dark:border-slate-600 rounded-lg overflow-hidden relative"
                            data-table-uid="table_partikel" onpaste="handleMixingPaste(event, this)">
                            <div class="absolute top-1 right-1 z-20 remove-table-btn">
                                <button type="button" onclick="toggleTableMenu(this)"
                                    class="flex items-center p-1.5 text-slate-400 hover:text-slate-600 dark:hover:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700 rounded-md transition-colors" title="Opsi">
                                    <span class="material-symbols-outlined text-[20px] block">more_vert</span>
                                </button>
                            ...
                            <div class="p-4">
                                <div class="paste-instructions border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-lg p-4 text-center bg-slate-50 dark:bg-slate-900/40 hover:border-blue-400 transition-colors cursor-pointer" onclick="focusClipboardField(this)">
                                    ...
                                    <textarea rows="3"
                                        class="clipboard-input-area w-full px-3 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-900 text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none font-mono"
                                        placeholder="Paste screenshot / tabel Excel di sini... (Ctrl+V)"
                                        onpaste="handleClipboardFieldPaste(event, this)"></textarea>
                                </div>
                                <input type="file" name="mixing_image_file[table_partikel]" accept="image/png, image/jpeg, image/jpg" class="hidden" onchange="previewImage(this)">
                            ...
                            <input type="hidden" name="bab22_table_subab_key[table_partikel]" value="partikel_asing">
                            <input type="hidden" name="existing_mixing_image_file[table_partikel]" value="">
                            <input type="hidden" name="mixing_pasted_table_json[table_partikel]" value="">
                            <input type="hidden" name="mixing_image_base64[table_partikel]" value="">
                        </div>
                    </div>
                    <button type="button" onclick="addMixingTableToSubab(this)"
                        class="mt-3 w-full py-2 border-2 border-dashed border-slate-300 dark:border-slate-600 rounded-lg text-slate-500 dark:text-slate-400 hover:border-red-400 hover:text-red-600 transition-colors flex items-center justify-center gap-2 text-sm">
                        <span class="material-symbols-outlined text-[18px]">add</span>
                        <span class="font-medium">Tambah Tabel</span>
                    </button>
                    ...
                    <div class="bab2-section mt-6" data-section-id="3">
                        ...
                        <div class="bab2-section-content transition-opacity duration-200">
                            ...
                            <div class="ml-4 mb-6 p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-700">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-300 mb-4">2.3.1 Tahap Pencampuran</h4>

                                {{-- 2.3.1.1 --}}
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        <span class="font-semibold">2.3.1.1</span>
                                        Proses pencampuran produk antara
                                        ...
                                        <input type="text" name="tujuan_mesin" class="template-input sync-input w-64" data-sync="mesin" value="Double Cone Mixer DC 40" placeholder="Double Cone Mixer DC 40">.
                                    </p>
                                </div>
                                ...
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        ...
                                        <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">,
                                        no. dokumen
                                        <input type="text" name="pencampuran_no_dokumen" class="template-input w-44" placeholder="AI-F03-3-A0018-00">,
                                        tanggal
                                        <input type="text" name="pencampuran_tanggal_dokumen" class="template-input w-28" placeholder="24-06-2024">,
                                        maka produk antara tahap pencampuran dilakukan pemeriksaan
                                        <input type="text" name="pencampuran_identifikasi" class="template-input w-36" placeholder="identifikasi">
                                        sebagai pendataan, dengan penerimaan sebagai berikut:
                                    </p>
                                    <div class="mixing-tables-container flex flex-col gap-3 ml-4">
                                ...
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        ...
                                        Pada tahap pencampuran dilakukan sampling sebanyak
                                        ...
                                        <input type="text" name="pencampuran_pemeriksaan_jenis" class="template-input w-64" placeholder="identifikasi Grape Seed Extract">
                                ...
                                <div class="mixing-table-item border border-slate-300 dark:border-slate-600 rounded-lg overflow-hidden relative mt-3"
                                    ...
                                    <div class="ml-6 mb-3">
                                        <p class="text-base text-slate-700 dark:text-slate-300">
                                            <span class="font-semibold">2.3.1.3.2</span>
                                            Hasil pemeriksaan
                                            <input type="text" name="pencampuran_identifikasi" class="template-input w-36" placeholder="identifikasi">
                                            pada tahap pencampuran produk
                                            <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">
                                            batch
                                            <input type="text" name="batch_name" class="template-input sync-input w-52" data-sync="batch" placeholder="NOV25A01 dan NOV25A02">
                                            menunjukkan bahwa pada seluruh sampel telah
                                            <input type="text" name="pencampuran_pemeriksaan_jenis" class="template-input w-64" placeholder="teridentifikasi Grape Seed Extract">.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="ml-4 mb-6 p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-700">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-300 mb-4">2.3.2 Tahap Kapsulasi</h4>

                                {{-- 2.3.2.1 --}}
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        <span class="font-semibold">2.3.2.1</span>
                                        Tahap kapsulasi produk
                                        <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">
                                        batch
                                        <input type="text" name="batch_name" class="template-input sync-input w-52" data-sync="batch" placeholder="NOV25A01 dan NOV25A02">
                                        dilakukan menggunakan mesin
                                        <input type="text" name="tujuan_mesin_kapsulasi" class="template-input w-64" value="Kapsulasi Bosch Type GKF 400" placeholder="Kapsulasi Bosch Type GKF 400">.
                                    </p>
                                </div>
                                ...
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        <span class="font-semibold">2.3.2.2</span>
                                        Spesifikasi Produk
                                        <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">
                                        batch
                                        <input type="text" name="batch_name" class="template-input sync-input w-52" data-sync="batch" placeholder="NOV25A01 dan NOV25A02">
                                        pada tahap kapsulasi sesuai dengan Spesifikasi Produk
                                        <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">,
                                        no. dokumen
                                        <input type="text" name="kapsulasi_no_dokumen" class="template-input w-44" placeholder="AI-F03-3-A0018-00">,
                                        tanggal
                                        <input type="text" name="kapsulasi_tanggal_dokumen" class="template-input w-28" placeholder="24-06-2024">
                                ...
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        <span class="font-semibold">2.3.2.3</span>
                                        Pada tahap kapsulasi dilakukan sampling sebanyak
                            ...
                            <div class="ml-4 mb-6 p-4 bg-slate-50 dark:bg-slate-900/30 rounded-lg border border-slate-200 dark:border-slate-700">
                                <h4 class="font-semibold text-slate-700 dark:text-slate-300 mb-4">2.3.3 Tahap Kemas Primer</h4>
                                ...
                                <div class="ml-4 mb-4">
                                    <p class="text-base text-slate-700 dark:text-slate-300 mb-2">
                                        ...
                                        <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">,
                                        no. dokumen
                                        <input type="text" name="kemasan_no_dokumen_produk" class="template-input w-44" placeholder="AI-F03-3-A0018-00">,
                                        tanggal
                                        <input type="text" name="kemasan_tanggal_dokumen_produk" class="template-input w-28" placeholder="24-06-2024">
                                        dan Spesifikasi Kemasan
                                        <input type="text" name="tujuan_nama_produk" class="template-input sync-input w-48" data-sync="nama_produk" placeholder="Nutracare Grape Seed">,
                                        no. dokumen
                                        <input type="text" name="kemasan_no_dokumen" class="template-input w-44" placeholder="AI-F04-3-A0015-01">,
                                        tanggal
                                        <input type="text" name="kemasan_tanggal_dokumen" class="template-input w-28" placeholder="06-11-2025">
                                        adalah sebagai berikut:
                                    </p>
                                    <div class="mixing-tables-container flex flex-col gap-3 ml-4">
                                <div class="mixing-table-item border border-slate-300 dark:border-slate-600 rounded-lg overflow-hidden relative mt-3"
    ...
    <script>
        ...
        function collectFormValues() {
            ...
            document.querySelectorAll(
                    '#nutracaregrapeTemplateForm input[name]:not([type="file"]), #nutracaregrapeTemplateForm textarea[name], #nutracaregrapeTemplateForm select[name]'
                )
                .forEach(input => {
        ...
        function collectDraftState() {
            ...
            document.querySelectorAll(
                    '#nutracaregrapeTemplateForm input[name], #nutracaregrapeTemplateForm textarea[name], #nutracaregrapeTemplateForm select[name]')
                .forEach(field => {
                    if (field.disabled) {
        ...
        async function saveDraft() {
            ...
            try {
                const form = document.getElementById('nutracaregrapeTemplateForm');
                const formData = new FormData(form);
                formData.delete('_token');
                formData.append('_token', CSRF_TOKEN);
                const state = collectDraftState();

                const product = (state.form_values.judul_nama_produk || '').trim() || 'Nutracare Grape Seed';
        ...
        const SAVE_DRAFT_URL = "{{ route('template-summary.nutracaregrape.draft', [], false) }}";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Sync semua field setelah subab dinamis selesai di-render
            // (event delegation sudah dipasang di luar DOMContentLoaded)

            // ===========================================
            // FORM SUBMIT: Pastikan semua base64 & tabel
            // ter-serialize ke hidden input sebelum export
            // ===========================================
            const siladexForm = document.getElementById('nutracaregrapeTemplateForm');
            if (siladexForm) {
                siladexForm.addEventListener('submit', function() {
                    showExportModal();
                    document.querySelectorAll('.mixing-table-item').forEach(tableItem => {
                        const tableUid = getTableUidFromItem(tableItem);
                        if (!tableUid) return;
        ...
        // ==============================================
        // SYNC INPUT — dihandle oleh script terpisah
        // di bawah, setelah Export Loading Modal.
        // ==============================================
        ...
        function showExportModal() {
            ...
            if (!tokenInput) {
                ...
                document.getElementById('nutracaregrapeTemplateForm').appendChild(tokenInput);
            }
