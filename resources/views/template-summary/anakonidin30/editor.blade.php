...
@section('content')
    <form action="{{ route('template-summary.anakonidin30.export') }}" method="POST" id="anakonidin30TemplateForm"
                    ...
                    <div class="text-base leading-relaxed text-slate-700 dark:text-slate-300 template-text">
                        ...
                        <p class="font-bold text-center text-base mb-4">
                            (<input type="text" name="judul_formula" class="template-input sync-input w-48"
                                data-sync="formula" placeholder="Formula Zat Aktif">) DI LINE
                        ...
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                <textarea name="tujuan_mesin" class="template-input sync-input w-full resize-none overflow-hidden" 
                                    ...
                                    placeholder="Mesin mixer Indo Laval 600L+holding tank, Mesin blow and suck Fillomatic Tornado 8SA, dan Mesin filling-capping Krones V0-G 024-188"
                                    oninput="this.style.height = 'auto'; this.style.height = this.scrollHeight + 'px'">Mesin mixer Indo Laval 600L+holding tank, Mesin blow and suck Fillomatic Tornado 8SA, dan Mesin filling-capping Krones V0-G 024-188</textarea>
                        ...
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                Atribut yang diuji pada tahap awal filling-capping (<input type="text"
                                    name="kesimpulan_fillingawal_atribut" class="template-input w-96"
                    ...
                    <div class="kesimpulan-section" data-section-id="5">
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                (<input type="text" name="kesimpulan_formula" class="template-input sync-input w-48"
                                    data-sync="formula" placeholder="Formula Zat Aktif">)
                                dinyatakan
    ...
    <script>
        ...
        function collectFormValues() {
            ...
            document.querySelectorAll(
                    '#anakonidin30TemplateForm input[name]:not([type="file"]), #anakonidin30TemplateForm textarea[name], #anakonidin30TemplateForm select[name]'
                )
                .forEach(input => {
        ...
        function collectDraftState() {
            ...
            document.querySelectorAll(
                    '#anakonidin30TemplateForm input[name], #anakonidin30TemplateForm textarea[name], #anakonidin30TemplateForm select[name]')
                .forEach(field => {
                    if (field.disabled) {
        ...
        async function saveDraft() {
            ...
            try {
                const form = document.getElementById('anakonidin30TemplateForm');
        ...
        const SAVE_DRAFT_URL = "{{ route('template-summary.anakonidin30.draft', [], false) }}";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ===========================================
            const anakonidin30Form = document.getElementById('anakonidin30TemplateForm');
            if (anakonidin30Form) {
                anakonidin30Form.addEventListener('submit', function() {
                    showExportModal();
        ...
        function showExportModal() {
            ...
            if (!tokenInput) {
                ...
                document.getElementById('anakonidin30TemplateForm').appendChild(tokenInput);
            }
