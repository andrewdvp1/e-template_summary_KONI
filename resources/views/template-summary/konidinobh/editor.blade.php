                    ...
                    <div class="text-base leading-relaxed text-slate-700 dark:text-slate-300 template-text">
                        ...
                        <p class="font-bold text-center text-base mb-4">
                            ...
                            <input type="text" name="judul_line" class="template-input sync-input w-8" data-sync="line"
                                placeholder="5"> (SACHET)
                            BAGIAN
                            <input type="text" name="judul_bagian" class="template-input sync-input w-96 uppercase"
                                data-sync="bagian" value="Production (Pharmaceutical III) Gedung B"
                                placeholder="Production (Pharmaceutical III) Gedung B">
                        </p>
                    </div>
                        ...
                        <div class="bab1-section-content ml-4 text-base leading-relaxed text-slate-700 dark:text-slate-300 template-text text-justify transition-opacity duration-200">
                            <p>
                                ...
                                <input type="text" name="kemasan_produk" class="template-input sync-input w-64"
                                    data-sync="kemasan" placeholder="(sachet)">
                                di Line
                                ...
                                <input type="text" name="tujuan_mesin" class="template-input sync-input w-154"
                                    data-sync="mesin"
                                ...
                                <input type="text" name="varian_produk" class="template-input sync-input w-48"
                                    data-sync="varian" placeholder="kemasan sachet">
                    ...
                    <div class="bab2-section" data-section-id="1">
                        <div class="bab2-section-content text-base leading-relaxed text-slate-800 dark:text-slate-300 template-text text-justify transition-opacity duration-200">
                            ...
                            <input type="text" name="rangkuman_metode" class="template-input sync-input w-115"
                                    data-sync="rangkuman"
                                    value="Penimbangan bahan baku, Mixing, dan sachetting"
                                    placeholder="Penimbangan bahan baku, Mixing, dan sachetting">
                    ...
                    <div class="kesimpulan-section" data-section-id="2">
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                <input type="text" name="kesimpulan_tahap_proses" class="template-input w-128"
                                    value="(bentuk, warna, aroma, pH, kadar zat aktif, kadar pengawet)"
                                    placeholder="(bentuk, warna, aroma, pH, kadar zat aktif, kadar pengawet)">
                    ...
                    <div class="kesimpulan-section" data-section-id="3">
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                <input type="text" name="kesimpulan_kadar" class="template-input w-86"
                    ...
                    <div class="kesimpulan-section" data-section-id="4">
                        <div
                            ...
                            <p class="pl-8 -indent-8">
                                ...
                                Atribut yang diuji pada tahap sachetting produk suspensi ke dalam sachet
                            </p>
                            <div class="flex items-start gap-1 mt-1 ml-8">
                              
                                <input type="text" name="kesimpulan_zat_aktif" 
    ...
    <script>
        ...
        function collectFormValues() {
            ...
            document.querySelectorAll(
                    '#konidinobhTemplateForm input[name]:not([type="file"]), #konidinobhTemplateForm textarea[name], #konidinTemplateForm select[name]'
                )
                .forEach(input => {
        ...
        function collectDraftState() {
            ...
            document.querySelectorAll(
                    '#konidinobhTemplateForm input[name], #konidinobhTemplateForm textarea[name], #konidinobhTemplateForm select[name]')
                .forEach(field => {
                    if (field.disabled) {
        ...
        function upgradeDraftTerminology() {
            // Upgrade old drafts that use "filling-capping" terminology to "sachetting"
            document.querySelectorAll('.bab22-subab').forEach(subab => {
                const key = subab.dataset.subabKey;
                const titleEl = subab.querySelector('.bab22-title');
                
                // Update data-subab-key attributes
                if (key === 'filling_awal') {
                    subab.dataset.subabKey = 'sachetting_awal';
                    if (titleEl) titleEl.textContent = 'Awal Sachetting';
                    
                    // Update all related input names
                    subab.querySelectorAll('input[name*="filling_awal"]').forEach(input => {
                        input.name = input.name.replace('filling_awal', 'sachetting_awal');
                    });
                    
                    // Update closing text content
                    subab.querySelectorAll('p').forEach(p => {
                        if (p.textContent.includes('awal filling-capping')) {
                            p.innerHTML = p.innerHTML.replace(/awal filling-capping/g, 'awal sachetting');
                        }
                    });
                } else if (key === 'filling_capping') {
                    subab.dataset.subabKey = 'sachetting';
                    if (titleEl) titleEl.textContent = 'Sachetting';
                    
                    // Update all related input names
                    subab.querySelectorAll('input[name*="filling_capping"]').forEach(input => {
                        input.name = input.name.replace('filling_capping', 'sachetting');
                    });
                    
                    // Update closing text content
                    subab.querySelectorAll('p').forEach(p => {
                        if (p.textContent.includes('filling-capping') && !p.textContent.includes('awal filling-capping')) {
                            p.innerHTML = p.innerHTML.replace(/filling-capping/g, 'sachetting');
                        }
                    });
                }
                
                // Update bab22_table_subab_key hidden inputs
                subab.querySelectorAll('input[name^="bab22_table_subab_key"]').forEach(input => {
                    if (input.value === 'filling_awal') {
                        input.value = 'sachetting_awal';
                    } else if (input.value === 'filling_capping') {
                        input.value = 'sachetting';
                    }
                });
            });
            
            // Force re-render to ensure changes are visible in both light and dark mode
            renumberBab22Subab();
        }
        ...
        async function saveDraft() {
            ...
            try {
                ...
                const product = (state.form_values.judul_nama_produk || '').trim() || 'Konidin OBH';
        ...
        const SAVE_DRAFT_URL = "{{ route('template-summary.konidinobh.draft', [], false) }}";
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (INITIAL_DRAFT_STATE) {
                ...
                // Upgrade old drafts: rename "filling-capping" sections to "sachetting"
                upgradeDraftTerminology();
                
                // Ensure Mixing section exists in container
                if (bab22Container && firstBab22Subab && !bab22Container.contains(firstBab22Subab)) {
                    bab22Container.prepend(firstBab22Subab);
                    attachBab22DragEvents(firstBab22Subab);
                }
                
                // Check if sachetting sections exist, if not create them
                const hasFillingAwal = Array.from(bab22Container?.querySelectorAll('.bab22-subab') || [])
                    .some(s => s.dataset.subabKey === 'sachetting_awal' || s.dataset.subabKey === 'filling_awal');
                const hasFillingCapping = Array.from(bab22Container?.querySelectorAll('.bab22-subab') || [])
                    .some(s => s.dataset.subabKey === 'sachetting' || s.dataset.subabKey === 'filling_capping');
                ...
                if (!hasFillingAwal) {
                    addBab22DefaultSubab(
                        ...
                        'sachetting_awal',
                        'awal sachetting',
                        'sachetting_awal_hasil',
                        'Spesifikasi Produk'
                    );
                }
                
                if (!hasFillingCapping) {
                    addBab22DefaultSubab(
                        'Sachetting',
                        'sachetting',
                        'sachetting',
            ...
            // ===========================================
            const konidinForm = document.getElementById('konidinobhTemplateForm');
            if (konidinForm){
                konidinForm.addEventListener('submit', function() {
                    showExportModal();
                    document.querySelectorAll('.mixing-table-item').forEach(tableItem => {
                        const tableUid = getTableUidFromItem(tableItem);
                        if (!tableUid) return;
        ...
        function showExportModal() {
            ...
            if (!tokenInput) {
                ...
                document.getElementById('konidinobhTemplateForm').appendChild(tokenInput);
            }
